    ...
    const reportHTML = `
      <div style="font-family: 'Segoe UI', sans-serif; padding: 40px; max-width: 800px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="color: #10b981; margin: 0;">📊 EconSim</h1>
        ...
        <div style="background: linear-gradient(135deg, #f0fdf4 0%, #ecfeff 100%); padding: 20px; border-radius: 12px; margin-bottom: 20px;">
          <h2 style="color: #047857; margin-top: 0;">💰 Income Tax Summary (FY 2025-26)</h2>
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 8px 0; color: #666;">Annual Income</td>
              <td style="padding: 8px 0; text-align: right; font-weight: bold;">₹${taxData.income?.toLocaleString('en-IN') || 0}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 8px 0; text-align: right; font-weight: bold;">₹${taxData.totalTax?.toLocaleString('en-IN') || 0}</td>
            </tr>
            <tr>
            ...
            <tr style="border-top: 1px solid #ddd;">
              ...
              <td style="padding: 12px 0; text-align: right; font-weight: bold; color: #10b981; font-size: 18px;">₹${taxData.savings?.toLocaleString('en-IN') || 0}</td>
            </tr>
          </table>
        </div>

        <div style="background: linear-gradient(135deg, #fff7ed 0%, #fef3c7 100%); padding: 20px; border-radius: 12px; margin-bottom: 20px;">
          <h2 style="color: #c2410c; margin-top: 0;">🛒 Monthly GST Impact</h2>
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 8px 0; color: #666;">Total Monthly Spending</td>
              <td style="padding: 8px 0; text-align: right; font-weight: bold;">₹${gstData.totalExpense?.toLocaleString('en-IN') || 0}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666;">GST Paid (Monthly)</td>
              <td style="padding: 8px 0; text-align: right; font-weight: bold; color: #f59e0b;">₹${gstData.totalGST?.toLocaleString('en-IN') || 0}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666;">GST Paid (Annual)</td>
              <td style="padding: 8px 0; text-align: right; font-weight: bold; color: #f59e0b;">₹${((gstData.totalGST || 0) * 12).toLocaleString('en-IN')}</td>
            </tr>
            <tr>
        ...
        <div style="background: #f8fafc; padding: 20px; border-radius: 12px; margin-bottom: 20px;">
          <h2 style="color: #475569; margin-top: 0;">📝 Tax Saving Tips</h2>
          <ul style="color: #666; line-height: 1.8;">
            ${taxData.betterRegime === 'new' ? `
              ...
              <li>Your income up to ₹12.75L is effectively tax-free with standard deduction</li>
            ` : `
              <li>Maximize Section 80C investments (₹1.5L limit)</li>
              <li>Get health insurance for 80D deduction (up to ₹50K)</li>
              <li>Consider NPS for additional ₹50K deduction under 80CCD(1B)</li>
            `}
          </ul>
        </div>
